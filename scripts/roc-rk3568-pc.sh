...
# 输出帮助信息
usage() {
    printf '适用于 ROC-RK3588-PC 开发板的 Linux & ArceOS 构建脚本\n'
    printf '\n'
    printf '用法:\n'
    printf '  scripts/roc-rk3568-pc.sh [命令] [选项]\n'
    printf '\n'
    printf '命令:\n'
    ...
    printf '\n'
    printf '示例:\n'
    printf '  scripts/roc-rk3568-pc.sh all                # 构建全部\n'
    printf '  scripts/roc-rk3568-pc.sh linux              # 仅构建 Linux\n'
}
