...
usage() {
    ...
    printf '\n'
    printf '用法:\n'
    printf '  scripts/qemu.sh <命令> <系统> [选项]\n'
    printf '\n'
    printf '命令:\n'
    printf '  aarch64                           构建 AArch64 架构的所有系统\n'
    printf '  x86_64                            构建 x86_64 架构的所有系统\n'
    printf '  riscv64                           构建 RISC-V 架构的所有系统\n'
    printf '  all                               构建支持的所有架构的所有系统\n'
